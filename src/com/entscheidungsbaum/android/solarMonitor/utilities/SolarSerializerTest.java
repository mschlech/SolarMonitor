 ...
 * @author mschlech
 * 
 *         SolarSerializerTest like Team class
 */

public class SolarSerializerTest extends MapStoredEntity implements CsvDeserializable {

	public SolarSerializerTest(Map<String, String> map) {
		super(map);
	}
